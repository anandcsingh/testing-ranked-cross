...
import type { Ranked } from '../../contracts/src/Ranked';

const state = {
  Ranked: null as null | typeof Ranked,
  zkapp: null as null | Ranked,
...
const functions = {
  ...
  loadContract: async (args: {}) => {
    const { Ranked } = await import('../../contracts/build/src/Ranked.js');
    state.Ranked = Ranked;
  },
