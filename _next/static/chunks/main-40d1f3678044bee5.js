...
const basePath = "/testing-ranked-cross" || 0;
...
function AppContainer(param) {
    ...
    return /*#__PURE__*/ _react.default.createElement(Container, {
        ...
        value: {"deviceSizes":[640,750,828,1080,1200,1920,2048,3840],"imageSizes":[16,32,48,64,96,128,256,384],"path":"/testing-ranked-cross/_next/image","loader":"default","dangerouslyAllowSVG":false,"unoptimized":true}
    }, children)))))));
}
...
class Router {
   ...
   */ prefetch(url) {
    ...
    constructor(pathname1, query1, as1, { initialProps , pageLoader , App , wrapApp , Component , err , subscription , isFallback , locale , locales , defaultLocale , domainLocales , isPreview  }){
        ...
        this.basePath = "/testing-ranked-cross" || 0;
