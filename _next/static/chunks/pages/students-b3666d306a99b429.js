...
/* harmony import */ var _modules_Rank__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(2581);
...
function Students() {
    let [state, setState] = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)({
        zkappWorkerClient: _modules_Authentication__WEBPACK_IMPORTED_MODULE_5__/* ["default"].zkClient */ .Z.zkClient,
        addSuccess: false,
        addAttempt: false,
        addMessage: null
    });
    const promoteStudent = async (event)=>{
        ...
        const ma = new _modules_Rank__WEBPACK_IMPORTED_MODULE_8__/* .Rank */ .y();
...
/******/ __webpack_require__.O(0, [829,16,863,675,312,893,774,888,179], function() { return __webpack_exec__(6307); });
